...
const CustomCursor = () => {
    ...
    const cursorVariants = {
        default: {
            ...
            backgroundColor: 'rgba(0, 242, 255, 0)',
        },
        pointer: {
            width: 40,
            height: 40,
...
const teamMembers = [
    ...
    {
        name: "Gibran Putra Maulana Salim",
        role: "Anggota",
        isLeader: false,
